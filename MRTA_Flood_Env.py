...
quantile_05_model = sm.regression.quantile_regression.QuantReg(y, X).fit(q=0.1)
...
def scale_action_values(action_values):
    ...
    scaled_values[0] = (action_values[0] * (15.17 - 4.17)) + 4.17
    ...
    speed_value = (action_values[1] * (42.47 - 19.76)) + 19.76
