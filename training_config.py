...
def get_config(args=None):
    ...
    parser.add_argument('--n_locations', type=int, default=31, help="Number of locations (including the depot if any).")
    ...
    parser.add_argument('--n_robots', type=int, default=2, help="Number of robots")
    ...
    parser.add_argument('--total_steps', type=int, default=6000000, help='Total number of steps')
    ...
    parser.add_argument('--val_coef', type=float, default=0.8, help='Value coefficient')
